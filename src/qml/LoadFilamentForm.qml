...
import FilamentProcessStateTypeEnum 1.0
...
Item {
    ...
    property int currentTemperature: 999
    property int targetTempertaure: 999
    property bool filamentBaySwitchActive
    property int bayID
    ...
    Image {
        ...
        Item {
            ...
            Text {
                ...
                height: 105
                color: "#cbcbcb"
                text: "Open material bay 2 and insert the MakerBot Smart Spool. Feed the end of the material into the slot until you feel it being pulled in."
                anchors.top: parent.top
    ...
    states: [
        ...
        State {
            name: "State2"
            when: bot.process.filamentStateType == FilamentProcessStateType.Preheating

            PropertyChanges {
                target: main_instruction_text
                text: "EXTRUDER 1 IS HEATING UP"
            }
        ...
        State {
            name: "State3"
            when: bot.process.filamentStateType == FilamentProcessStateType.Extrusion
        ...
        State {
            name: "State4"
            when: bot.process.filamentStateType == FilamentProcessStateType.Stopping
