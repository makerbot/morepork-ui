...
LoggingItem {
    ...
    SnipMaterialScreen {
        ...
        visible: !snipMaterialAlertAcknowledged && !usingExpExtruder && !bayFilamentSwitch
    }
    ...
    states: [
        State {
            name: "feed_filament"
            when: isMaterialValid && !usingExpExtruder && !bayFilamentSwitch &&
            ...
            PropertyChanges {
                target: snipMaterial
                visible: !snipMaterialAlertAcknowledged && !usingExpExtruder
            }
