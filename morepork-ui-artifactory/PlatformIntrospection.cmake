...
# https://github.com/couchbase/tlm/blob/master/cmake/Modules/ParseArguments.cmake


# Tries to determine the current Linux distribution and architecture.
# Sets _mb_platform so that it corresponds with a platform name
# that corresponds for the artifactory.
macro(_DETERMINE_MB_PLATFORM _mb_platform)
  _DETERMINE_PLATFORM(PLATFORM)
  message(STATUS "_DETERMINE_PLATFORM(): ${PLATFORM}")
  set(_platform "")
  if(PLATFORM STREQUAL "ubuntu14.04")
    set(_platform "Ubuntu_1404")
  elseif(PLATFORM STREQUAL "ubuntu16.04")
    set(_platform "Ubuntu_1604")
  elseif(PLATFORM STREQUAL "ubuntu18.04")
    set(_platform "Ubuntu_1804")
  elseif(PLATFORM STREQUAL "fedora30")
    set(_platform "Fedora_30")
  elseif(PLATFORM STREQUAL "fedora31")
    set(_platform "Fedora_31")
  else()
    set(_platform "Ubuntu_1604")
  endif()
  _DETERMINE_ARCH(ARCH)
  message(STATUS "_DETERMINE_ARCH(): ${ARCH}")
  if(ARCH STREQUAL "x86")
    set(_platform "${_platform}_32")
  elseif(ARCH STREQUAL "amd64" OR ARCH STREQUAL "x86_64")
    set(_platform "${_platform}_64")
  else()
    set(_platform "${_platform}_64")
  endif()
  set(${_mb_platform} ${_platform})
endmacro(_DETERMINE_MB_PLATFORM)
